...
async function main() {
  ...
  await q("truncate notifications, activity_log, expenses, invoices, clients, performance_reviews, payroll_runs, attendance, leave_requests, employees, departments restart identity cascade");
